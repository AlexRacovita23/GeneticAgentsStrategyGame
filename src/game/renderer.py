...
class PygameRenderer(BaseRenderer):
    ...
    def render(self, game: GameState = None, ui_state=None) -> None:
        if game is not None:
            self.game = game

        if ui_state is not None:
            self.selected_cell = ui_state.selected_cell
            self.highlighted_cells = ui_state.highlighted_cells
            self.troop_selection = ui_state.troop_selection
            self.flanking_mode = ui_state.flanking_mode
            self.flanking_target = ui_state.flanking_target
            self.flanking_sources = ui_state.flanking_sources
            self.flanking_pending_source = ui_state.flanking_pending_source
            self.flanking_pending_troops = ui_state.flanking_pending_troops
            self.conquered_this_turn = ui_state.conquered_this_turn
            self.immobile_troops = ui_state.immobile_troops
            self.status_message = ui_state.status_message
