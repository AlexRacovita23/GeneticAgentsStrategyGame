...
class Board:
    ...
    def move_troops(
        ...
        if dest.owner == source.owner:
            ...
            if combat_resolver is None:
                return self._default_combat(source, dest, troops_moved)
            else:
                return combat_resolver(source, dest, troops_moved)
    ...
    def _default_combat(
        ...
        if attackers > defenders:
            ...
            return MoveOutcome(
                ...
                troops_lost_attacker=defenders,
                troops_lost_defender=defenders,
            )
        else:
            dest.troops = defenders - attackers
            return MoveOutcome(
                result=MoveResult.REPELLED,
                troops_moved=attackers,
                troops_lost_attacker=attackers,
                troops_lost_defender=attackers,
            )
